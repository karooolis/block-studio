...
const defaultMeta = {
  title: "Blockstudio.xyz",
  siteName: "Blockstudio.xyz",
  description:
    "Your trusted Web3 development studio. We build decentralized applications, smart contracts, and more.",
  url: "https://www.blockstudio.xyz",
  type: "website",
  robots: "follow, index",
  /**
   ...
   */
  image: 'https://www.blockstudio.xyz/images/static-preview.jpeg',
};
